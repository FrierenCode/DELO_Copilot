...
export const metadata: Metadata = {
  ...
  // 130자 목표: 구체적 입력(채널명) → 출력(구조화·견적) → 차별점(무료·로그인 불필요) 순서
  description:
    "이메일·인스타 DM·카카오톡으로 받은 브랜드 협찬 문의를 붙여넣으면 AI가 핵심 조건을 구조화하고, 구독자 규모와 산출물 기준으로 적정 견적 범위를 계산합니다. 회원가입 없이 무료로 체험할 수 있습니다.",
  keywords: [
