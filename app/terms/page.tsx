        ...
        <div className="max-w-[720px] mx-auto">
          <div className="bg-[#13131A] border border-[#1E1E2E] rounded-xl p-8">
            ...
            <article className="space-y-10 text-slate-200/90" style={{ lineHeight: 1.8 }}>
              ...
              <section id="t1">
                <h2 className="text-lg font-bold mb-3 text-white">1. 서비스 성격</h2>
                <p>
              ...
              <section id="t2">
                <h2 className="text-lg font-bold mb-3 text-white">2. 이용 조건</h2>
                <p>
              ...
              <section id="t3">
                <h2 className="text-lg font-bold mb-3 text-white">3. 플랜 및 결제</h2>
                <p>
              ...
              <section id="t4">
                <h2 className="text-lg font-bold mb-3 text-white">4. 책임 제한</h2>
                <p>
              ...
              <section id="t5">
                <h2 className="text-lg font-bold mb-3 text-white">5. 면책 고지</h2>
              ...
              <section id="t6">
                <h2 className="text-lg font-bold mb-3 text-white">6. 문의</h2>
                <p>
                  약관 관련 문의:{" "}
                  <a
