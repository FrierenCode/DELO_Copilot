              ...
              <article className="space-y-10 text-slate-200/90" style={{ lineHeight: 1.8 }}>
                ...
                <section id="p1">
                  ...
                  <p className="mt-4 text-sm text-slate-400">
                    ...
                    비회원(미로그인 상태)이 분석 기능을 이용할 경우 분석 요청 식별 정보만 임시 저장되며,
                ...
                <section id="p2">
                  ...
                  <Table rows={[
                    ...
                    ["AI 문의 분석·견적 산출·답장 초안 제공", "분석 요청 내용(원문 저장 없음), 크리에이터 프로필"],
                    ["딜 진행 저장·추적", "딜 정보, 계정 식별자"],
                    ["요금제 관리 및 결제 처리", "구독 상태, Polar 고객 ID"],
                    ["서비스 개선 및 통계 분석", "서비스 이용 기록(개인 식별 불가)"],
                ...
                <section id="p3">
                  ...
                  <p className="mt-4 text-sm text-slate-400">
                    브랜드 문의 원문은 AI 처리 완료 즉시 파기되며, 중복 분석 방지를 위한 식별 정보는
                    계정 삭제 시까지 보관됩니다.
                  </p>
                </section>
